...
#define S1D_DISPLAY_PCLK		166667;		// 6MHz
...
#define BS60_INIT_FSLEN         4		//frame sync length
#define BS60_INIT_FBLEN         4		//frame begine length
#define BS60_INIT_FELEN         10		//frame end length
#define BS60_INIT_LSLEN         10		//line sync length
#define BS60_INIT_LBLEN         4		//line begine length
#define BS60_INIT_LELEN         100		//line end length

//Pixel Clock Divide Select bits
#define BS60_INIT_PIXCLKDIV     6
//source driver configuration register.
//(1<<9) => parallel output to source driver, P0, P1, P2, P3
#define BS60_INIT_SDRV_CFG      (100 | (1<< 8) | (1<<9))

// Gate Driver Configuration Register.
#define BS60_INIT_GDRV_CFG      0x2

//Update Buffer Configuration Register. 
// 4: P4N, (1<<7): LUT auto select enable.
#define BS60_INIT_LUTIDXFMT     (4 | (1<<7))

/*rotation mode => 0: 0 degrees, 1: 90 degrees, 2: 180 degrees, 3: 270 degrees*/
#define BS60_INIT_ROTMODE       3// 1

#define WF_MODE_INIT            0	//display initialzation
#define WF_MODE_MU              1	//monochrome menu, text input, touch screen/pen input(black and white.)
#define WF_MODE_GU              2	//high quality images and anti-aliased text
#define WF_MODE_GC              3	//high quality images and anti-aliased text
#define WF_MODE_PU              4	
