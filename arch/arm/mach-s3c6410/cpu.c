...
extern int do_changing_clock(unsigned int a);
extern int s3c6410_pm_all_gpio_to_input(void);
void __init s3c6410_init_clocks(int xtal)
{
	printk("%s: initialising clocks\n", __func__);
	/* Added by woong */
	__raw_writel(0xdffe4b00, S3C_NORMAL_CFG); //20Á¤µµ ¶³¾îÁü 169 //DOMAIN-F¸¸ »ì¸°´Ù.
	do_changing_clock(8);
	/* end */
