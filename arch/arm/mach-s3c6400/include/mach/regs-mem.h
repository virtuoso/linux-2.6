...
//janged add start for smc9217
#define S3C64XX_SROM_BW_DATA_WIDTH4_8BIT	(0 << 16)
#define S3C64XX_SROM_BW_DATA_WIDTH4_16BIT	(1 << 16)
#define S3C64XX_SROM_BW_DATA_WIDTH4_MASK	(1 << 16)

#define S3C64XX_SROM_BW_WAIT_ENABLE4_DISABLE	(0 << 18)
#define S3C64XX_SROM_BW_WAIT_ENABLE4_ENABLE	(1 << 18)
#define S3C64XX_SROM_BW_WAIT_ENABLE4_MASK		(1 << 18)

#define S3C64XX_SROM_BW_BYTE_ENABLE4_DISABLE	(0 << 19)
#define S3C64XX_SROM_BW_BYTE_ENABLE4_ENABLE	(1 << 19)
