...
static struct sleep_save core_save[] = {
...
#if 0
	SAVE_ITEM(S3C64XX_EINT0PEND),
	SAVE_ITEM(S3C64XX_EINT0MASK),
	SAVE_ITEM(S3C_EINT_MASK)
#endif
#if 0	
#if 1
	...
	//Low Clock으로 간 후에 sleep으로 진입하니깐 기억할 필요가 없다.
...
static void s3c6410_pm_configure_extint(void)
{
	...
	//elice에서는 power key를 wakeup source로 사용해야 한다.
	set_irq_type(S3C_EINT(12), IRQ_TYPE_LEVEL_HIGH);
	...
	//__raw_writel((0x0fffffff&~(3<<11)), S3C_EINT_MASK);

	//elice에서는 ESB Detect Pin도 wakeup source로 사용해야 한다.
	set_irq_type(S3C_EINT(26), IRQ_TYPE_LEVEL_HIGH);
	...
	__raw_writel((0x0fffffff&(~(3<<25)||~(3<<11))), S3C_EINT_MASK);
}

void elisa_pm_gpio_to_input_for_low_clock(void)
{
	unsigned int gpio;
	unsigned int end;
...
EXPORT_SYMBOL(elisa_pm_gpio_to_input_for_low_clock);

#if 0
void gpio_sleep_config(void)
{
	__raw_writel(0x2, S3C64XX_GPACONSLP);
	__raw_writel(0x1, S3C64XX_GPAPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPBCONSLP);
	__raw_writel(0x1, S3C64XX_GPBPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPCCONSLP);
	__raw_writel(0x1, S3C64XX_GPCPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPDCONSLP);
	__raw_writel(0x1, S3C64XX_GPDPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPECONSLP);
	__raw_writel(0x1, S3C64XX_GPEPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPFCONSLP);
	__raw_writel(0x1, S3C64XX_GPFPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPGCONSLP);
	__raw_writel(0x1, S3C64XX_GPGPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPHCONSLP);
	__raw_writel(0x1, S3C64XX_GPHPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPICONSLP);
	__raw_writel(0x1, S3C64XX_GPIPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPJCONSLP);
	__raw_writel(0x1, S3C64XX_GPJPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPOCONSLP);
	__raw_writel(0x1, S3C64XX_GPOPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPPCONSLP);
	__raw_writel(0x1, S3C64XX_GPPPUDSLP);
	
	__raw_writel(0x2, S3C64XX_GPQCONSLP);
	__raw_writel(0x1, S3C64XX_GPQPUDSLP);
}
#else
void gpio_sleep_config(void)
{
	__raw_writel(0x0101, S3C64XX_GPACONSLP);
	__raw_writel(0x0000, S3C64XX_GPAPUDSLP);
	
	__raw_writel(0x1451, S3C64XX_GPBCONSLP);
	__raw_writel(0x0000, S3C64XX_GPBPUDSLP);
	
	__raw_writel(0x0002, S3C64XX_GPCCONSLP);
	__raw_writel(0x0002, S3C64XX_GPCPUDSLP);
	
	__raw_writel(0x080, S3C64XX_GPDCONSLP);
	__raw_writel(0x040, S3C64XX_GPDPUDSLP);
	
	__raw_writel(0x000, S3C64XX_GPECONSLP);
	__raw_writel(0x000, S3C64XX_GPEPUDSLP);
	
	__raw_writel(0x00000000, S3C64XX_GPFCONSLP);
	__raw_writel(0x00000000, S3C64XX_GPFPUDSLP);
	
	__raw_writel(0x100, S3C64XX_GPGCONSLP);
	__raw_writel(0x000, S3C64XX_GPGPUDSLP);
	
	__raw_writel(0x00000, S3C64XX_GPHCONSLP);
	__raw_writel(0x00000, S3C64XX_GPHPUDSLP);
	
	__raw_writel(0x00000000, S3C64XX_GPICONSLP);
	__raw_writel(0x00000000, S3C64XX_GPIPUDSLP);
	
	__raw_writel(0x414000, S3C64XX_GPJCONSLP);
	__raw_writel(0x000000, S3C64XX_GPJPUDSLP);
	
	__raw_writel(0x00000010, S3C64XX_GPOCONSLP);
	__raw_writel(0x00000000, S3C64XX_GPOPUDSLP);
	
	__raw_writel(0x0000000, S3C64XX_GPPCONSLP);
	__raw_writel(0x0000000, S3C64XX_GPPPUDSLP);
	
	__raw_writel(0x0000, S3C64XX_GPQCONSLP);
	__raw_writel(0x0000, S3C64XX_GPQPUDSLP);
}
#endif
EXPORT_SYMBOL(gpio_sleep_config);
...
EXPORT_SYMBOL(enable_all_clock);

void (*pm_cpu_prep)(void);
void (*pm_cpu_sleep)(void);

void elisa_save_core_register(void)
{
...
EXPORT_SYMBOL(elisa_save_core_register);
...
*/
extern int do_changing_clock(unsigned int a);		//janged_clk
extern void otg_phy_off(void);
extern void resume_gpio(void);
extern void gpio_set_output_low(void);
...
static int s3c6410_pm_enter(suspend_state_t state)
{
...
#if 0	
	//__raw_writel(0x00004001, S3C64XX_SPCONSLP);
	//__raw_writel(0x01, S3C64XX_SLPEN);
#endif
#if 1
#if 1
	__raw_writel(0x00fff0f4, S3C64XX_MEM0CONSLP0);
	__raw_writel(0x0157ffff, S3C64XX_MEM0CONSLP1);
	__raw_writel(0x3ffff444, S3C64XX_MEM1CONSLP);
#else
	__raw_writel(0x00fff0f4, S3C64XX_MEM0CONSLP0);
	__raw_writel(0x03ffffff, S3C64XX_MEM0CONSLP1);
	__raw_writel(0x3ffff777, S3C64XX_MEM1CONSLP);	
#endif
#else
	__raw_writel(0x00555054, S3C64XX_MEM0CONSLP0);
	__raw_writel(0x01555555, S3C64XX_MEM0CONSLP1);
	__raw_writel(0x3ffff774, S3C64XX_MEM1CONSLP);
#endif

	//codec power down시켜야함.
	otg_phy_off();
	
	//printk("s3c_spc_base=0x%08lx\n", __raw_readl(S3C64XX_SPC_BASE));
	//__raw_writel(0xbfc115c8, S3C64XX_SPC_BASE);
	__raw_writel(0xbfd151c8, S3C64XX_SPC_BASE);
	//printk("2 s3c_spc_base=0x%08lx\n", __raw_readl(S3C64XX_SPC_BASE));
	...
	tmp |= (0x1<<8);
	tmp |= (0x1<<9);
	//tmp |= (0x1<<10);  //RTC wakeup source enable
	tmp |= (0x1<<11);
	tmp |= (0x1<<12);
	tmp |= (0x1<<13);
	tmp |= (0x1<<14);
	...
	//__raw_writel(0x0003ff79, S3C_PWR_CFG);
	...
	printk("Finish S3C6410 PM Resume (post-restore)\n");
	//__raw_writel(0xdffe4b00, S3C_NORMAL_CFG);
	printk("s3c_pwr_cfg = 0x%08x\n", __raw_readl(S3C_PWR_CFG));
	printk("s3c_normal_cfg = 0x%08x\n", __raw_readl(S3C_NORMAL_CFG));
	//do_changing_clock(6); janged
