...
void __init_or_cpufreq s3c6400_setup_clocks(void)
{
...
#else
	{
		...
		s3c64xx_setparent_clksrc(&clk_mmc0.clk, &clk_mout_epll.clk);
		s3c64xx_setparent_clksrc(&clk_mmc1.clk, &clk_mout_epll.clk);
		s3c64xx_setparent_clksrc(&clk_mmc2.clk, &clk_mout_epll.clk);
		s3c64xx_setparent_clksrc(&clk_audio0.clk, &clk_mout_epll.clk);
		s3c64xx_setparent_clksrc(&clk_audio1.clk, &clk_mout_epll.clk);
		s3c64xx_setparent_clksrc(&clk_uart_uclk1.clk, &clk_mout_epll.clk);
		...
		#if 0
		tmp = readl(S3C_CLK_SRC);
		writel(tmp | 0x00500000, S3C_CLK_SRC);
		tmp = readl(S3C_CLK_DIV1);
		writel(tmp | 0x00000550, S3C_CLK_DIV1);
		#endif
	}
